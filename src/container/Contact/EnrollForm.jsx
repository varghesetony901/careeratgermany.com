...
const EnrollForm = () => {
    ...
    const [formData, setFormData] = useState({ name: '', email: '', message: '' , contactNumber: '', course: ''});
    ...
    return (
        <>
            ...
            <h2 className="head-text app__footer"><span>Enroll Now</span></h2>

            <div className="app__footer-cards">
                <div className="app__footer-card ">
                    <AiFillMail size={30} />
                    {/* <img src={images.email} alt="email" /> */}
                    <a href="mailto:careeratgermany@gmail.com" className="p-text">careeratgermany@gmail.com</a>
                </div>
                <div className="app__footer-card">
                    <BsTelephoneOutbound size={25} />
                    {/* <img src={images.mobile} alt="phone" /> */}
                    <a href="tel:+91 7994779575" className="p-text">+91 799 477 9575</a>
                </div>
            </div>
            {!isFormSubmitted ? (
                <div className="app__footer-form app__flex">
                    ...
                    <div className="app__flex">
                        <input className="p-text" type="number" placeholder="Your Contact Number" name="contactNumber" value={contactNumber} onChange={handleChangeInput} />
                    </div>
                    <div className="app__flex">
                        <input className="p-text" type="email" placeholder="Your Email" name="email" value={email} onChange={handleChangeInput} />
                    </div>
                    <div className='app__flex'>
                        <select className="p-text" name="course" onChange={handleChangeInput} >
