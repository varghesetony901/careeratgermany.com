            ...
            {model &&
                <div className='whatsapp_model_container'>
                    ...
                    <div className='model_bottom_input_box'>
                        <input type="text" placeholder='Type Message' name="message" value={textMessage} onChange={handleInput} />
                        <a href={`https://wa.me/+917994779575?text=${textMessage}`} target='_blank'>
