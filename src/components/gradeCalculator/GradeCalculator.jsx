...
function GradeCalculator() {
    ...
    const calculateGermanGrade = () => {
        const result = (maxForeignGrade - foreignGrade) / (maxForeignGrade - minPassingGrade) * 3 + 1;
        ...
        <div className='grade_calc-container'>
            ...
            <div className='grade_calc_contents'>
                ...
                <label className='calc-input_fields'>
                    <p>
                        Maximum Grade in your Grading System :
                    </p>
                    <input
                        type="number"
                ...
                <label className='calc-input_fields'>
                    <p>
                        ...
                        Minimum Grade in your Grading System :
                    </p>
                    <input
                        type="number"
                        placeholder='Enter a valid number'
                ...
                <button className='grade_btn' onClick={calculateGermanGrade}>Calculate German Grade</button>
